...
def plot_skeleton_kpts(im, kpts, steps, orig_shape=None, thresh=0.5):
    ...
    for sk_id, sk in enumerate(skeleton):
        ...
        if steps == 3:
            ...
            if conf1<thresh or conf2<thresh:
                continue
...
#def plot_skeleton_kpts2(im, kpts, steps, color=(255,0,0), orig_shape=None):
def plot_skeleton_kpts2(im, kpts, steps, color=(255,0,0), orig_shape=None, thresh=0.5):
    #Plot the skeleton and keypointsfor coco datatset
    skeleton = [[16, 14], [14, 12], [17, 15], [15, 13], [12, 13], [6, 12],
                [7, 13], [6, 7], [6, 8], [7, 9], [8, 10], [9, 11], [2, 3],
                [1, 2], [1, 3], [2, 4], [3, 5], [4, 6], [5, 7]]
